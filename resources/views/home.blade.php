...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-5">
                         <p>Welcome to a Professional Zara Therapy Clinic</p>
                    </div>
          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <li><a href="{{route('pages.createuser')}}" class="smoothScroll">Contact</a></li>
               ...
               <div class="row">
                         ...
                         <div class="owl-carousel owl-theme">
                              ...
                              <div class="item item-second">
                                   <div class="caption">
                                        <div class="col-md-offset-1 col-md-10">
                                             <h3>Our thoughtfulness</h3>
                                             <h1>Will give you a new life style</h1>
	...
	-->
     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.938819426904!2d106.69488951428734!3d10.815994061420913!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317528eb784f3199%3A0xb44665f2a57e1aea!2zN0EgVHLhuqduIFF1w70gQ8OhcCwgUGjGsOG7nW5nIDExLCBCw6xuaCBUaOG6oW5oLCBUaMOgbmggcGjhu5EgSOG7kyBDaMOtIE1pbmgsIFZp4buHdCBOYW0!5e0!3m2!1svi!2s!4v1657173973345!5m2!1svi!2s" width="1400" height="500" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>  </section>           


     <!-- FOOTER -->
     <footer data-stellar-background-ratio="5" style="background-color: rgba(192, 148, 67, 0.411);">
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="footer-thumb"> 
                              ...
                              <b>Contact a counselor to help you better understand all the information you need in the most accurate way.</b>

                              <div class="contact-info">
                                   <b><i class="fa fa-phone"></i> 0379348103</b>
                                   <br></br>
                                   <p><i class="fa fa-envelope-o"></i> <a href="">thai.vm704@aptechlearning.edu.vn</a></p>
                              </div>
                         </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4"> 
                         <div class="footer-thumb">
                              ...
                              <ul class="social-icon">
                                   <li><a href="https://www.facebook.com/nemo1309" class="fa fa-facebook-square" attr="facebook icon"></a></li>
                                   <li><a href="#" class="fa fa-twitter"></a></li>
                                   <li><a href="https://www.instagram.com/vmt_1324/" class="fa fa-instagram"></a></li>
                              </ul>
                         </div>
                    </div>
                    ...
                    <div class="col-md-12 col-sm-12 border-top">
                         <div class="col-md-4 col-sm-6">
                              <div class="copyright-text"> 
                                   <p>Copyright &copy; 2022 Your Company | Design: <a rel="nofollow" target="_parent">JOKE</a></p> 
                              </div>
                         </div>
                         <div class="col-md-6 col-sm-6">
